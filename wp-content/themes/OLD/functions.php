...
{
    echo '<p>Hello There!  Click on the link below to quickly access your WordPress guide </p><ul><li><h2><a style="text-decoration:none;" href="google.com">Read the Documentation</a></h2></li></ul>
    <b>Code Tips</b>
    <ul><li>Embed Slider to Post: [post_gallery]</li></li>
<b>Recommended Default Image Sizes</b>
<ul><li>Hero Images:</li>
<li>Playbook Post Image:</li>
<li>Testimonial Images: 265px x 275px</li>
<li>Parallax Images: 1200px x 495px</li>
<li>Post Slider Images: 800px x 400px
</li>
<li>Showcase Images:</li></ul>';
}
